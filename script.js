...
game.enemigos_array.map((enemigo,i)=>{  //bala y enemigo son objetos temporales
		...
		if(enemigo != null && bala != null){
			if ((bala.x > enemigo.x) && 
			   ...
			   (bala.y < enemigo.y + enemigo.w)){
				...
				game.enemigos_array[i] = null; //con esto lo desaparecemos
				game.balas_array[j] = null;//esto es porque cuando mate al enemigo la bala tambien desaparece
				game.puntos += 10;
				sonidos.boing.play();
...
const marcador = () =>{
	...
	game.ctx.font= "bold 20px Courier";
	game.ctx.fillText(
		"SCORE: " + game.puntos +" "+ "VIDAS:"  +" "+ game.vidas  +" "+ "BALAS:"  +" "+ game.balas, 10,20 //el 10 y  20 son las medidas
	);
	game.ctx.restore(); */
